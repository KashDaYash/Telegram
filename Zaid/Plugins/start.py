...
async def start(event):
    ...
    if event.is_private:
       ...
       await event.reply(
             ...
             buttons=[
        [Button.url("Add me to your group ➕", url="t.me/DynicaBot?startgroup=true")],
        [Button.url("Channel 📢", url="t.me/DynicaBots"), Button.url("Support 🌎", url="t.me/DynicaSupport")],
...
async def help(event):
    if event.is_group:
        buttons = [
            [Button.url("❔ Help", "https://t.me/DynicaBot?start=_help")],
        ]
        await event.reply(
